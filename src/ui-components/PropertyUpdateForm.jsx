...
export default function PropertyUpdateForm(props) {
  ...
  const [num_bed, setNum_bed] = React.useState(initialValues.num_bed);
  ...
  const resetStateValues = () => {
    ...
    setNum_bed(cleanValues.num_bed);
      ...
      <TextField
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            value = result?.num_bed ?? value;
          }
          if (errors.num_bed?.hasError) {
            runValidationTasks("num_bed", value);
          }
          setNum_bed(value);
        }}
        onBlur={() => runValidationTasks("num_bed", num_bed)}
        errorMessage={errors.num_bed?.errorMessage}
        hasError={errors.num_bed?.hasError}
        {...getOverrideProps(overrides, "num_bed")}
      ></TextField>
      <TextField
        label="Num bath"
        isRequired={false}
